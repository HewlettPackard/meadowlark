#ifndef YCSB_C_KVS_DB_TINY_H_
#define YCSB_C_KVS_DB_TINY_H_
...
class KVSDB_TINY : public DB {
 public:
    KVSDB_TINY(KeyValueStore::IndexType type, std::string root, std::string base, std::string user, size_t size):
        kvs_(nullptr) {
        //std::cout << "KVSDB_TINY() " << root << std::endl;
    ...
    int Read(const std::string &table, const std::string &key,
        ...
        static size_t const max_val_len = 8;
        uint64_t val;
    ...
    int Update(const std::string &table, const std::string &key,
        ...
        // encode value
        //std::string val_buf=values[0].second;
        std::string val_buf="12345678";
